              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="Esports Services">Esports Services</option>
                  </select>
                </div>
                <div>
                ...
                <div>
                  <button
                    type="submit"
                    className="w-full inline-flex justify-center py-3 px-6 border border-transparent shadow-sm text-base font-medium rounded-md text-white bg-secondary hover:bg-secondary/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-secondary"
                  >
                    Send Message
                  </button>
                </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-3">
                      ...
                      <p className="mt-2 text-gray-600">info@pixelplaystudios.com</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    <div className="flex-shrink-0">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="h-96 rounded-lg overflow-hidden shadow-lg">
            ...
            <div className="w-full h-full bg-gray-300 flex items-center justify-center">
              <p className="text-gray-600 text-lg font-medium">Map Placeholder - Google Maps would be embedded here</p>
            </div>
          </div>
        </div>
      </div>
